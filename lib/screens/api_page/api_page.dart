...
class _ApiPageState extends State<ApiPage> {
  ...
  CategoriesData() async {
    ...
    var response = await http.get(url, headers: {
      "x-guest-token": "U2FsdGVkX1+WVxNvXEwxTQsjLZAqcCKK9qqQQ5sUlx8aPkMZ/FyEyAleosfe07phhf0gFMgxsUh2uDnDSkhDaAfn1aw6jYHBwdZ43zdLiTcZedlS9zvVfxYG67fwnb4U454oAiMV0ImECW1DZg/w3aYZGXZIiQ+fiO4XNa1y1lc0rHvjKnPkgrYkgbTdOgAfnxnxaNHiniWClKWmVne/0vO0s6Vh7HpC0lRjs0LKTwM="
    });
    print('Response status: ${response.statusCode}');
    if (response.statusCode == 200) {
      print('Response body: ${response.body}');
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                audioStatus ? (a.length > 0 ? Container(
                  height: 150,
                 width: double.infinity,
                       ...
                       children: [
                         Padding(
                           ...
                           child: Container(
                             ...
                             width: 200,
                             decoration: BoxDecoration(
                               image: DecorationImage(image: NetworkImage("${audiobooks.photoUrl}")),
                         ...
                         Padding(
                           ...
                           child: Text("${audiobooks.name}",style: TextStyle(fontSize: 30,color: Colors.white)),
                         ),
                       ],
                      );
                  ...
                  child: Text("No Data Found"),)) : Center(
                  child: CircularProgressIndicator(),),
                //AudioBooks
                Align(
                    alignment: Alignment.topLeft,
                ...
                audioS ? (audio!.data!.homeCategoryList!.first.idList!.length > 0 ? Container(
                  height: 150,
                  width: double.infinity,
                  child: ListView.builder(
                    scrollDirection: Axis.horizontal,
                    itemCount: audio!.data!.homeCategoryList!.first.idList!.length,
                    itemBuilder: (context, index) {
                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                              ...
                              width: 200,
                              decoration: BoxDecoration(
                                image: DecorationImage(image: NetworkImage("${audio!.data!.homeCategoryList!.first.idList![index].audioBookDpUrl}")),
